...
const CACHE = 'shoot-unlimited-v4';
const FILES = ['./', 'index.html', 'manifest.webmanifest', 'icon.svg', 'js/data.js', 'js/engine.js', 'js/platform.js', 'js/game.js', 'js/render.js', 'js/ui.js'];
