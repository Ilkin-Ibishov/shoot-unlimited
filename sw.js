...
const CACHE = 'shoot-unlimited-v5';
const FILES = ['./', 'index.html', 'manifest.webmanifest', 'icon.svg', 'js/data.js', 'js/engine.js', 'js/dsp.js', 'js/audio.js', 'js/audio-worker.js', 'js/platform.js', 'js/game.js', 'js/render.js', 'js/ui.js'];
