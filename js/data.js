...
const ERAS = [
  { name: 'Zombie City', year: '2026 AD', hp: 0.7, coin: 1, bg: 'city', cloud: 0.75,
    ...
    foes: {
      walker:   { name: 'Zombie',      deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#aab34c', s: '#a9c2da', p: '#2e3f57' } },
      runner:   { name: 'Sprinter',    deco: 'torn', face: 'zombie', legs: 'run',    look: { k: '#b3b852', s: '#b8453e', p: '#394055' } },
      flyer:    { name: 'Gargoyle',    rig: 'flyer', fly: 'gargoyle',   look: { k: '#8e949c', s: '#767c85', a: '#5f646c' }, blood: '#666' },
      ranged:   { name: 'Spitter',     deco: 'torn', face: 'zombie', arms: 'aim',    look: { k: '#b9c45e', s: '#6d8b3c', p: '#2e3445' }, proj: 'goo' },
      exploder: { name: 'Bloater',     deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#c2c46a', s: '#e5dca0', p: '#3a3f55' }, scale: 1.15, blood: '#9acd32' },
      shield:   { name: 'Riot Zombie', deco: 'armor', face: 'zombie', arms: 'shield', look: { k: '#aab34c', s: '#223a5e', p: '#1b2436', sh: '#5d6d80' }, hat: 'helmet', held: 'shield' },
      brute:    { name: 'Tank',        deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#98a444', s: '#8b8b8b', p: '#3b3b3b' } },
      boss:     { name: 'Patient Zero', deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#9aa640', s: '#e8ecee', p: '#2e3445' }, moves: ['summon', 'charge'] },
    } },
