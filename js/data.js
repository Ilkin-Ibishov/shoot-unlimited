...
const ERAS = [
  { name: 'Zombie City', year: '2026 AD', hp: 0.7, coin: 1, bg: 'city', cloud: 0.75,
    ...
    foes: {
      walker:   { name: 'Zombie', anim: 'zombie', deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#aab34c', s: '#a9c2da', p: '#2e3f57' } },
      runner:   { name: 'Sprinter', anim: 'sprinter', deco: 'torn', face: 'zombie', legs: 'run', look: { k: '#b3b852', s: '#b8453e', p: '#394055' } },
      flyer:    { name: 'Gargoyle',    rig: 'flyer', fly: 'gargoyle',   look: { k: '#8e949c', s: '#767c85', a: '#5f646c' }, blood: '#666' },
      ranged:   { name: 'Spitter',     anim: 'spitter', deco: 'torn', face: 'zombie', arms: 'aim',    look: { k: '#b9c45e', s: '#6d8b3c', p: '#2e3445' }, proj: 'goo' },
      exploder: { name: 'Bloater',     anim: 'bloater', deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#c2c46a', s: '#e5dca0', p: '#3a3f55' }, scale: 1.15, blood: '#9acd32' },
      shield:   { name: 'Riot Zombie', anim: 'shield',  deco: 'armor', face: 'zombie', arms: 'shield', look: { k: '#aab34c', s: '#223a5e', p: '#1b2436', sh: '#5d6d80' }, hat: 'helmet', held: 'shield' },
      brute:    { name: 'Tank', anim: 'tank', deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#98a444', s: '#8b8b8b', p: '#3b3b3b' } },
      boss:     { name: 'Patient Zero', anim: 'boss',   deco: 'torn', face: 'zombie', arms: 'zombie', look: { k: '#9aa640', s: '#e8ecee', p: '#2e3445' }, moves: ['summon', 'charge'] },
    } },
  { name: 'Jurassic', year: '65M BC', hp: 2, coin: 1.5, bg: 'jungle', sun: '#ffd27a', cloud: 0.6, tuft: '#5f8a34',
    ...
    foes: {
      ...
      runner:   { name: 'Raptor',      rig: 'raptor', dino: 'raptor', scale: 1.2, look: { k: '#6f9a3c', s: '#5d8a33', p: '#4a6e28' } },
      ...
      brute:    { name: 'Bonecrusher', rig: 'raptor', dino: 'crusher', scale: 1.25, look: { k: '#6d7f9a', s: '#5b6e8a', p: '#4a5a70' } },
      boss:     { name: 'T-Rex',       rig: 'raptor', dino: 'rex', scale: 1.35, look: { k: '#7a5a3a', s: '#6b4d31', p: '#553b25' }, moves: ['charge', 'summon'], proj: 'rock' },
    } },
